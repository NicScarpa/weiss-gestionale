...
Generato da `scripts/piano-v4/02-report-mappatura.ts` il 2026-08-10T21:50:23.941Z.
...
- Database letto: `nicolascarpa@mappatura_prod su 127.0.0.1:5433`
...
| --- | --- | --- | ---: | ---: | --- | --- | --- | --- |
| `400` | Ricavi | RICAVO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `400.01` | Ricavi da vendite bar | RICAVO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `400.02` | Ricavi da vendite caffetteria | RICAVO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `400.03` | Ricavi da eventi | RICAVO | 0 | 0 | nessuno | disattivare | 11.02 — Ricavi eventi privati e compleanni *(suggerito)* | — |
| `500` | Costi | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `500.01` | Acquisti materie prime | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `500.02` | Acquisti bevande | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `510` | Costi personale | COSTO | 0 | 0 | nessuno | disattivare | 28.4.05 — Altri costi per personale dipendente *(suggerito)* | — |
| `510.01` | Stipendi dipendenti | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `510.02` | Compensi extra | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `520` | Costi per servizi | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `520.01` | Pulizie | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `520.02` | Utenze | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `520.03` | Manutenzioni | COSTO | 0 | 0 | nessuno | disattivare | 23.01 — Manutenzioni e riparazioni *(suggerito)* | — |
| `530` | Costi amministrativi | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `530.01` | Commissioni bancarie | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `530.02` | Commissioni POS | COSTO | 0 | 0 | nessuno | disattivare | — (da decidere) | — |
| `100` | Cassa | ATTIVO | 0 | 0 | nessuno | conservare (patrimoniale, fuori dal perimetro v4) | — (il piano v4 copre solo il conto economico) | — |
| `110` | Banca | ATTIVO | 0 | 0 | nessuno | conservare (patrimoniale, fuori dal perimetro v4) | — (il piano v4 copre solo il conto economico) | — |
| `200` | Debiti v/fornitori | PASSIVO | 0 | 0 | nessuno | conservare (patrimoniale, fuori dal perimetro v4) | — (il piano v4 copre solo il conto economico) | — |
