...
|---|---|---|
| Indici parziali (`… WHERE …`) | no — tiene nome e colonne, **scarta il predicato** | 8 |
| Policy e Row Level Security | no | 59 tabelle, 59 policy |
| Vincoli `CHECK` | no | 0 (ne arriva uno con `conti/piano-v4`) |
