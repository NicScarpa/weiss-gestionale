...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // `w-fit` senza tetto prende la larghezza dell'opzione più lunga e su
        // schermo stretto esce dalla propria cella: `max-w-full` la limita al
        // contenitore, e `line-clamp-1` sul valore fa il resto.
